// https://github.com/snrylmz/il-ilce-json/
const data = [
    {
      "il_adi": "Adana",
      "plaka_kodu": " 01",
...
const { normalizeSync } = require('normalize-diacritics');
  ...
  module.exports.cities = data.map(({ il_adi, ilceler }) => normalizeSync(il_adi));

  module.exports.districts = data.reduce((acc, { il_adi, ilceler }) => {
    il_adi = normalizeSync(il_adi);
    return [
        ...acc,
        ...ilceler.map(({ ilce_adi }) => ({
            il_adi, ilce_adi: normalizeSync(ilce_adi)
        }))
    ]
}, []);

// console.log(JSON.stringify(module.exports.districts, null, 2));
